...
//    mainWin.rootViewController = vc;
      SuperViewController *superVc = [[SuperViewController alloc] init];
      [[UIApplication sharedApplication].delegate window].rootViewController = superVc;
