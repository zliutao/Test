...
-(void)layoutUI{
    ...
    self.line = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 0.5)];
    ...
    [self.shoppingCartBtn setBackgroundImage:[UIImage imageNamed:@"矩形-1"] forState:UIControlStateNormal];
    ...
    self.OverlayView = [[OverlayView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-50)];
